...
我們這組採用的是以上所提到的那三種來做模擬，我們是指用ORB來做alignment，而我們分別對alignment的係數做不同的模擬，一個是係數為500的時候，另一個則是係數為5000的時候，可以從底下的GIF看得出係數為5000的會比500來的好!從以下的不同的係數可以發現5000的時候，取出的feature越多，對應的線也越多，相對出做來的也越準!越不會跑掉!
